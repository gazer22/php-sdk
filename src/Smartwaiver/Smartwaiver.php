...
class Smartwaiver {
	 ...
	 */
	public function __construct( $apiKey, $guzzleOptions = array() ) {
		$this->apiKey = $apiKey;
	 ...
	 * @throws SmartwaiverSDKException
	 */
	public function getWaiverSummaries(
		$limit = 20,
		$verified = null,
		$templateId = '',
		$fromDts = '',
	 ...
	 * @throws SmartwaiverSDKException
	 */
	public function createDynamicTemplate(
		SmartwaiverTemplateConfig $templateConfig,
		SmartwaiverTemplateData $data,
		$expiration
	) {
		// Send the request and process the response
		$this->sendPostRequest(
			SmartwaiverRoutes::createDynamicTemplate(),
			array(
				'dynamic' => array(
	...
	public function processDynamicTemplate( $transactionId ) {
		...
		$this->sendPostRequest(
			SmartwaiverRoutes::processDynamicTemplate( $transactionId ),
			array(),
			array(
				'headers' => array(
	 ...
	 * unprocessed json.
	 */
	public function getWaiverSummariesRaw(
		$limit = 20,
		$verified = null,
		$templateId = '',
		$fromDts = '',
	 ...
	 * @throws SmartwaiverSDKException
	 */
	public function createDynamicTemplateRaw(
		SmartwaiverTemplateConfig $templateConfig,
		SmartwaiverTemplateData $data,
		$expiration
	) {
		// Send the request and return the response
		return $this->sendRawPostRequest(
			SmartwaiverRoutes::createDynamicTemplate(),
			array(
				'dynamic' => array(
					'expiration' => $expiration,
	 ...
	 * @throws SmartwaiverSDKException
	 */
	private function sendPostRequest( $url, $data, $extraOptions = array() ) {
		// Send the request and process the response
		try {
			$guzzleResponse = $this->client->request( 'POST', $url, array_merge( array( 'json' => $data ), $extraOptions ) );
	 ...
	 * @throws SmartwaiverSDKException
	 */
	private function sendRawPostRequest( $url, $data, $extraOptions = array() ) {
		// Send the request and process the response
		try {
			$guzzleResponse = $this->client->request( 'POST', $url, array_merge( array( 'json' => $data ), $extraOptions ) );
		} catch ( GuzzleException $e ) {
